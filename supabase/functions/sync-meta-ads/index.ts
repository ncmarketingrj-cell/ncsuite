...
serve(async (req) => {
  ...
  try {
    ...
    // Se foi chamado manualmente, tenta primeiro o do usuário logado
    ...
    // Fallback: se não tiver authUser ou não encontrar configuração, busca a mais recente da agência
